...
try:
    source = requests.get('https://www.cbinsights.com/research/well-funded-startups-us-map/')  # Table ---'https://darkgalaxies.mypinata.cloud/ipfs/QmUcyiWazZiAmLTKBds3niZMnA8pxSHA3rAtbRu8pL6jCY'
